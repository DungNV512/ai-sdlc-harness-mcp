...
### Stages D–P: Implementation & Delivery

| Stage | Owner | What it does | Status |
|---|---|---|---|
| D | Dev team | Code implementation against SRS | **not yet specified** |
| E | QA + Dev | Testing per test strategy | **not yet specified** |
| F | Dev + PM | Merge/release + notification | `/pr`, `/notify-merge`, `/ship-feature` |
